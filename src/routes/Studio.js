          ...
          sessions.map((session) => (
            <div className="studio-member">
              <div className="studio-member-top">
                <div className="studio-member-profile">
                  <img
                    className="studio-member-img"
                    ...
                    alt="profile"
                  />
                  <p className="studio-member-username">{session.username}</p>
                  <p className="studio-member-session">(guitar)</p>
                </div>
                <div className="studio-member-menu">
                  ...
                  <div className="studio-member-menu-item">(play)</div>
                  <div
                    className="studio-member-menu-item"
                    onClick={() => {
                      setUserUploaded((prev) => !prev);
                    }}
                  >
                    (setting)
                  </div>
